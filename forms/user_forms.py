...
class RegisterUser(FlaskForm):
    ...
    username = StringField(
        ...
        validators=[
            ...
            Regexp("^\w+$", message="Username cannot contain spaces"),
        ],
    )
    email = URLField(
        "Email", validators=[InputRequired(message="Email cannot be blank")]
    )
...
class LoginUser(FlaskForm):
    ...
    username = StringField(
        "Username", validators=[InputRequired(message="Username cannot be blank")]
    )
    password = PasswordField(
        "Password", validators=[InputRequired(message="Password cannot be blank")]
    )
...
class EditUser(FlaskForm):
    ...
    current_password = PasswordField(
        "Current Password",
        validators=[
            InputRequired(message="Current password must be entered for authentication")
        ],
    )
